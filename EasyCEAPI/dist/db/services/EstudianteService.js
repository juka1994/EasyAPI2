...
const estudiantDal = __importStar(require("../dal/Estudiante"));
const personaRolDal = __importStar(require("../dal/PersonaRol"));
const create = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    let student = payload.idPersonaRol;
    //Devuelve true es estudiante y false no es estudiante
    const checkIsStudent = yield personaRolDal.checkIsStudent(student);
    if (checkIsStudent) {
