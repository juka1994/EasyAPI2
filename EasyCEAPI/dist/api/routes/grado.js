...
gradeRouter.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const payload = req.body;
    const result = yield gradoController.create(payload);
    return res.status(200).send(result);
}));
gradeRouter.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const idGrado = Number(req.params.id);
    const result = yield gradoController.getById(idGrado);
    return res.status(200).send(result);
}));
gradeRouter.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = req.query;
    const result = yield gradoController.getAll(filter);
    return res.status(200).send(result);
}));
gradeRouter.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const idGrado = Number(req.params.id);
    const payload = req.body;
    const result = yield gradoController.update(idGrado, payload);
    return res.status(201).send(result);
}));
gradeRouter.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const idGrado = Number(req.params.id);
